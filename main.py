...
def part_2():
    ...
    st.run_sign_test(bigram_result_no_smoothing, bigram_result_smoothing, 'unigram')
    ...
    st.run_sign_test(both_result_no_smoothing, both_result_smoothing, 'unigram') # darwin mac
